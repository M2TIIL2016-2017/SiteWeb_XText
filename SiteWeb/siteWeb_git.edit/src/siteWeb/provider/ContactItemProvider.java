...
/**
 * This is the item provider adapter for a {@link siteWeb.Contact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContactItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Contact_nom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Contact_nom_feature", "_UI_Contact_type"),
				 SiteWebPackage.Literals.CONTACT__NOM,
				 true,
				 false,
				 false,
	...
	protected void addPrenomPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Contact_prenom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Contact_prenom_feature", "_UI_Contact_type"),
				 SiteWebPackage.Literals.CONTACT__PRENOM,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAdressePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Contact_adresse_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Contact_adresse_feature", "_UI_Contact_type"),
				 SiteWebPackage.Literals.CONTACT__ADRESSE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SiteWebPackage.Literals.CONTACT__TELEPHONE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Contact)object).getNom();
